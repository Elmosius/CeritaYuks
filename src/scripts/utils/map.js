...
export default class Map {
  ...
  constructor(selector, options = {}) {
    ...
    const tileStreets = tileLayer(`https://api.maptiler.com/maps/streets/{z}/{x}/{y}.png?key=${CONFIG.MAP_SERVICE_API_KEY}`, {
      attribution: '© <a href="https://maptiler.com/" target="_blank">MapTiler</a>',
    });

    const tileSatellite = tileLayer(`https://api.maptiler.com/maps/hybrid/{z}/{x}/{y}.jpg?key=${CONFIG.MAP_SERVICE_API_KEY}`, {
      attribution: '© <a href="https://maptiler.com/" target="_blank">MapTiler</a>',
    });
    ...
    const baseLayers = {
      ...
      "MapTiler Streets": tileStreets,
      "MapTiler Satellite": tileSatellite,
    };
